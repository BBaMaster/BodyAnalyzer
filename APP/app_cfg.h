...
#define  APP_CFG_TASK_I2C_STK_SIZE_PCT_FULL             90u
#define  APP_CFG_TASK_I2C_STK_SIZE_LIMIT           (APP_CFG_TASK_I2C_STK_SIZE  * (100u - APP_CFG_TASK_I2C_STK_SIZE_PCT_FULL))  / 100u
    
#define  APP_CFG_TASK_SPI_STK_SIZE_PCT_FULL             90u
#define  APP_CFG_TASK_SPI_STK_SIZE_LIMIT           (APP_CFG_TASK_I2C_STK_SIZE  * (100u - APP_CFG_TASK_I2C_STK_SIZE_PCT_FULL))  / 100u
