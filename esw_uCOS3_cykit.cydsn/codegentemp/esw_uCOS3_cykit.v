...
module top ;
	...
	cy_clock_v1_0
		#(.id("1d8e7c73-c68a-4f7c-aa6b-fccb37af1c90"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("1000000000"),
		  .is_direct(0),
	...
	wire [0:0] tmpOE__Pin_Blue_Led_net;
	wire [0:0] tmpFB_0__Pin_Blue_Led_net;
	wire [0:0] tmpIO_0__Pin_Blue_Led_net;
	wire [0:0] tmpINTERRUPT_0__Pin_Blue_Led_net;
	electrical [0:0] tmpSIOVREF__Pin_Blue_Led_net;

	cy_psoc3_pins_v1_10
		#(.id("528fda2f-50ac-470b-a0f3-2e552401c9e2"),
		  .drive_mode(3'b101),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_Blue_Led
		 (.oe(tmpOE__Pin_Blue_Led_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Pin_Blue_Led_net[0:0]}),
		  .io({tmpIO_0__Pin_Blue_Led_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_Blue_Led_net),
		  .interrupt({tmpINTERRUPT_0__Pin_Blue_Led_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pin_Blue_Led_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Pin_Green_Led_net;
	wire [0:0] tmpFB_0__Pin_Green_Led_net;
	wire [0:0] tmpIO_0__Pin_Green_Led_net;
	wire [0:0] tmpINTERRUPT_0__Pin_Green_Led_net;
	electrical [0:0] tmpSIOVREF__Pin_Green_Led_net;

	cy_psoc3_pins_v1_10
		#(.id("dd41dea9-a0fc-4fe4-819b-4f0f0af6a8b8"),
		  .drive_mode(3'b101),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_Green_Led
		 (.oe(tmpOE__Pin_Green_Led_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Pin_Green_Led_net[0:0]}),
		  .io({tmpIO_0__Pin_Green_Led_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_Green_Led_net),
		  .interrupt({tmpINTERRUPT_0__Pin_Green_Led_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pin_Green_Led_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Pin_Red_Led_net;
	wire [0:0] tmpFB_0__Pin_Red_Led_net;
	wire [0:0] tmpIO_0__Pin_Red_Led_net;
	wire [0:0] tmpINTERRUPT_0__Pin_Red_Led_net;
	electrical [0:0] tmpSIOVREF__Pin_Red_Led_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("e851a3b9-efb8-48be-bbb8-b303b216c393"),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_Red_Led
		 (.oe(tmpOE__Pin_Red_Led_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Pin_Red_Led_net[0:0]}),
		  .io({tmpIO_0__Pin_Red_Led_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_Red_Led_net),
		  .interrupt({tmpINTERRUPT_0__Pin_Red_Led_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pin_Red_Led_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
