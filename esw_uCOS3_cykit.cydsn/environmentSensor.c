...
void us_Delay(uint16_t period, void *intf_ptr){
...
static void bme688_Task(void *p_arg){
  ...
  bsp_i2c_read(0x76, 0xD0, &chip_Id,1);
  
  bme68x_get_regs(0xD0, &chip_Id, 1, NULL);  
...
//    
//    Log_Write(LOG_LEVEL_BME688,"gas: %d", data.gas_index);
//    
